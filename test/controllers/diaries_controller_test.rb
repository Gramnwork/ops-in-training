...
class DiariesControllerTest < ActionController::TestCase
  ...
  test "should create diary" do
    assert_difference('Diary.count') do
      post :create, diary: { content: @diary.content, title: @diary.title, user_prof_id: @diary.user_prof_id }
    end
  ...
  test "should update diary" do
    patch :update, id: @diary, diary: { content: @diary.content, title: @diary.title, user_prof_id: @diary.user_prof_id }
    assert_redirected_to diary_path(assigns(:diary))
  end
